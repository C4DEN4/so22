...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/area/{id}', [AreaController::class, 'area_destroy'])->name('area.destroy');
    ...
    Route::delete('/personas/{cedula}', [PersonaController::class, 'personas_destroy'])->name('personas.destroy');
