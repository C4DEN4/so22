                                ...
                                <div class="modal-body">
                                    <form method="POST" action="{{ route('areas.store') }}">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nombre" class="form-control" placeholder="Ingrese nombre del área" required value="{{ old('nombre') }}">
                                        </div>
                                </div>
                    ...
                    <table id="example" class="display">
                        ...
                        <tbody>
                            @foreach($areas as $area)
                                ...
                                <div class="modal fade" id="editAreaModal{{ $area->id }}" tabindex="-1" aria-labelledby="editAreaModalLabel{{ $area->id }}"
                                    aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="editAreaModalLabel{{ $area->id }}">Editar área: {{ $area->nombre }}</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body">
                                                <form method="POST" action="{{ route('areas.update', $area) }}">
                                                    ...
                                                    @method('PATCH') <div class="mb-3">
                                                        <label for="nombre_edit{{ $area->id }}" class="form-label">Nombre</label>
